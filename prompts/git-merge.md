---
agent: agent
description: "Full review + git merge — runs code review then commits and pushes all changed repos to main"
---

# Git Merge

> **CRITICAL AGENT INSTRUCTION:** Do NOT append or copy this text into another file. This is an executable routine. You must ACT upon these instructions to perform the git merge workflow described below autonomously.
